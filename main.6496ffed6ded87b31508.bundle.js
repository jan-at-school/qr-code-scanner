    ...
    'serviceWorker' in navigator &&
      window.addEventListener('load', () => {
        navigator.serviceWorker
          ...
          .then(e => {
            console.log('SW registered: ', e), localStorage.getItem('offline') || localStorage.setItem('offline', !0);
          })
          .catch(e => {
      ...
      window.addEventListener('DOMContentLoaded', () => {
        ...
        var e = null,
          ...
          r = document.querySelector('#app__dialog-heading'),
          c = document.querySelector('.app__dialog-open'),
          l = document.querySelector('.app__dialog-close'),
          s = document.querySelector('.custom-scanner'),
          u = document.querySelector('#result'),
          p = (document.querySelector('.app__help-text'),
          ...
          (function(e) {
            ...
            return (
              (e + '?')
                ...
                .split('&')
                .forEach(function(e) {
                  (e = (e + '=').split('=').map(decodeURIComponent))[0].length && (t[e[0]] = e[1]);
                }),
              t
            );
          })(window.location.href));
        function m(t = !1) {
          window.isMediaStreamAPISupported && !window.noCameraPermission && (s.style.display = 'block'),
            ...
            i.scan(t => {
              (e = t),
                ...
                d()(t) && (c.style.display = 'inline-block'),
                (function() {
                  p.hideURL || (u.style.display = 'none');
                  o.classList.remove('app__dialog--hide'), a.classList.remove('app__dialog--hide');
                })();
        ...
        console.log(p),
          (r.innerHTML = p.onSuccessMessage ? p.onSuccessMessage : 'Detected Successfully!'),
          (window.appOverlay = document.querySelector('.app__overlay')),
          window.addEventListener('load', e => {
            i.init(),
              setTimeout(() => {
                (window.appOverlay.style.borderStyle = 'solid'), window.isMediaStreamAPISupported && m();
              }, 1e3),
              (function() {
                ...
                o.appendChild(e),
                  ...
                  n.addEventListener('click', () => {
                    (s.style.display = 'none'), document.querySelector('#camera').click();
                  }),
                  e.addEventListener('change', e => {
                    e.target &&
                      ...
                      window.noCameraPermission || (s.style.display = 'block'),
                      (window.appOverlay.style.borderColor = 'rgb(62, 78, 184)'),
                      m(!0));
                  });
              })();
          }),
          l.addEventListener('click', v, !1),
          c.addEventListener(
            'click',
            function() {
              console.log('Result: ', e), window.open(e, '_blank', 'toolbar=0,location=0,menubar=0'), (e = null), v();
            },
            !1
          );
      });
